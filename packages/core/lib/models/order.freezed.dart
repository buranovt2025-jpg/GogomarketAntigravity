...
class _$OrderItemImpl implements _OrderItem {
  const _$OrderItemImpl({required this.product, required this.quantity});
...
class _$OrderImpl implements _Order {
  ...
  @override
  String toString() {
    return 'Order(id: $id, buyerId: $buyerId, items: $items, total: $total, status: $status, createdAt: $createdAt, courierId: $courierId, deliveryAddress: $deliveryAddress, note: $note)';
  }
